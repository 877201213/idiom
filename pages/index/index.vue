<template>
	<view class="container">
		...
		<view style="background-color: rgba(6,11,23,.8);height: 100%; text-align: center;" v-if="modelbox">
			<view style="position: relative;top: 20%;padding: 0px 15px;">
				<view style="color: white;width: 50px;float: right;"> 
					<button @click="modelboxFun()">X</button>
				 </view>
				<!-- 弹窗主体 -->
					<view style="background-image: url(../../static/images/redbag.png); width: 320px;height:420px;background-repeat: round;position: absolute;margin-left: 20px;top: 50%;margin-left: 25px;"></view>
					<view style="position: fixed;top: 55%;left: 22%;">
						<h2 style="color: rgb(255, 244, 152);font-size: 2.5rem;">￥10.00</h2>
					</view>

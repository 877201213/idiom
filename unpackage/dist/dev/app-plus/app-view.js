...
var eN=_mz(z,'image',['mode',10,'src',1],[],e,s,gg)
_(tM,eN)
var bO=_n('view')
...
var t1=_mz(z,'view',['bindtap',26,'class',1,'data-event-opts',2,'data-index',3],[],oX,cW,gg)
...
var oBB=_n('view')
var lCB=_mz(z,'view',['bindtap',40,'data-event-opts',1,'data-index',2],[],h9,c8,gg)
var aDB=_oz(z,43,h9,c8,gg)
_(lCB,aDB)
_(oBB,lCB)
_(o0,oBB)
return o0
